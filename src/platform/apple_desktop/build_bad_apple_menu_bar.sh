...
LOGIC_SOURCES=""
for src in BadAppleSecurity.swift BadAppleIdentityClient.swift BadAppleTools.swift BadAppleConversation.swift BadAppleRAG.swift BadAppleNativeRuntime.swift BadAppleAgent.swift BadAppleModelManager.swift BadAppleWorkspaceWatcher.swift BadAppleCouncil.swift; do
...
install -m 644 "${REPO_ROOT}/tokenizer.json" "${CONTENTS_DIR}/Resources/tokenizer.json" 2>/dev/null || true
