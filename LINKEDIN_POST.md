...
- governance · learning · dreaming · audit · sovereignty · continuity
...
I built it. I own it. No one else can turn it off.

Watch the proof → [video link when ready]
Attestation → proof/PERSONAL_AGI_ATTESTATION.md

#PersonalAGI #AGI #BadApple #SovereignAI #BareMetal #OnDevice #AppleSilicon
...
#PersonalAGI #AGI #SovereignAI #BareMetalAI #OnDeviceAI #AppleSilicon #MLX #Qwen

---

## What to attach

1. **The video** (`DEMO=1 PAUSE=2 ./personal_agi_proof.sh`).
2. **A screenshot of the scorecard** — the final `PASS: 22  FAIL: 0  OPTIONAL: 0` line.
3. **A screenshot of the `badapple receipts` proof card**:
   ```
   === BAD APPLE PROOF CARD ===
   version:    v0.4.1
   daemon:     running
   identity:   Secure Enclave (SLICKS v2)
   ledger:     11498 attested actions
   organism:   30 days old
   chain tip:  90cf832e1d5f2cee…
   sovereign:  sealed 11373 entries · secure-enclave · signed 2026-09-22T21:02:32.354764+00:00
   ify:        watching (gestation)
   ```
4. **The attestation** (`proof/PERSONAL_AGI_ATTESTATION.md`) as a PDF or the first comment.
...
- Post early in the day (8–10 AM PT) on a Tuesday/Thursday.
- Turn on "comment as a new post" for the attestation PDF.
- Pin the post to your profile.
- Respond to skeptics with: "The proof is machine-local, not cloud. Watch the video and run the same checks on your own install."
