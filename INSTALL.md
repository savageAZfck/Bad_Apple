...
- **8 GB of unified memory minimum; 16 GB is comfortable.** The 7B model uses
  about 4 GB at peak, plus whatever macOS and other apps need. Larger models
  (32B/70B) need more. Keep at least 40 GB free for the OS, model cache, and
  swap.
